// A high security level variable (private)
var password = cloakDeepak("temp1234",'h');

chkPass(password);

/* @b_sayed: Changed the strReverse function to be a regular function
 * rather than a function on the String prototype, since IF-Transipler
 * does not handle standard Runtime APIs yet.
 * */
...
function chkPass(pwd) {
    /* @b_sayed: commented the following 3 statements because
    ...
    */
    ...
    console.log("Complexity: " + sComplexity);
    //} else {
