...
function chkpassword(pwd) {
	var j, $tmp2, $tmp3;
	$Γ['global']['chkpassword']['$tmp3'] = $Γ['global']['chkpassword']['$tmp2'] = $Γ['global']['chkpassword']['j'] = 0;
	j = 0;
	...
	$tmp2 = j < 16;
	$Γ['global']['chkpassword']['$tmp2'] = sec_lvl('j', null, true, $Γ['global']['chkpassword']) >= $Λ[$Λ.length - 1].l ? sec_lvl('j', null, true, $Γ['global']['chkpassword']) : $Λ[$Λ.length - 1].l;
	...
	for (; $tmp2;) {
		var $tmp4, $tmp5, $tmp1, $tmp2;
		$Γ['global']['chkpassword']['$tmp2'] = $Γ['global']['chkpassword']['$tmp1'] = $Γ['global']['chkpassword']['$tmp5'] = $Γ['global']['chkpassword']['$tmp4'] = 0;
		$tmp5 = pwd.length;
		...
		$Λ.pop();
		$tmp1 = j++;
		$Γ['global']['chkpassword']['$tmp1'] = sec_lvl('j', null, false, $Γ['global']['chkpassword']);
