...
function chkpassword(pwd) {
	var array, $tmp1, j;
	$Γ['global']['chkpassword']['j'] = $Γ['global']['chkpassword']['$tmp1'] = $Γ['global']['chkpassword']['array'] = 0;
	array = [];
	...
	$tmp1 = pwd.length;
	$Γ['global']['chkpassword']['$tmp1'] = sec_lvl('pwd', 'length', false, $Γ['global']['chkpassword']);
	...
	array[$tmp1] = true;
	$scope($Γ['global']['chkpassword'], 'array', false)['array'][$tmp1] = $Λ[$Λ.length - 1].l;
	_$tmp = sec_lvl('$tmp1', null, false, $Γ['global']['chkpassword']) instanceof Object ? sec_lvl('$tmp1', null, false, $Γ['global']['chkpassword']).Σ : sec_lvl('$tmp1', null, false, $Γ['global']['chkpassword']);
	$scope($Γ['global']['chkpassword'], 'array', false)['array'][$tmp1] instanceof Object ? $scope($Γ['global']['chkpassword'], 'array', false)['array'][$tmp1].Σ = $lub($scope($Γ['global']['chkpassword'], 'array', false)['array'][$tmp1].Σ, _$tmp, $Λ[$Λ.length - 1].l) : $scope($Γ['global']['chkpassword'], 'array', false)['array'][$tmp1] = $lub($scope($Γ['global']['chkpassword'], 'array', false)['array'][$tmp1], _$tmp, $Λ[$Λ.length - 1].l);
	$Λ.push({
		l: $Λ[$Λ.length - 1].l,
		id: 'LOOP'
	});
	for (j in array) {
		...
		$tmp2 = array[j];
		$Γ['global']['chkpassword']['$tmp2'] = sec_lvl('array', j, false, $Γ['global']['chkpassword']);
		...
		if ($tmp2) {
			...
			$tmp3 = $output('j',j,$Γ['global']['chkpassword'],0,'suppress',$Λ[$Λ.length - 1].l);
		} else {
