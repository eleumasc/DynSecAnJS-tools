...
var pass, obj, $tmp0, $tmp1, $tmp2;
$Γ['global']['$tmp2'] = $Γ['global']['$tmp1'] = $Γ['global']['$tmp0'] = $Γ['global']['obj'] = $Γ['global']['pass'] = 0;
pass = 'temp1234';
...
function foo(pwd) {
	var $tmp3, $tmp4;
	$Γ['global']['foo']['$tmp4'] = $Γ['global']['foo']['$tmp3'] = 0;
	$tmp4 = pwd.length;
	$Γ['global']['foo']['$tmp4'] = sec_lvl('pwd', 'length', false, $Γ['global']['foo']);
	...
	$tmp3 = $tmp4 >= 9;
	$Γ['global']['foo']['$tmp3'] = sec_lvl('$tmp4', null, true, $Γ['global']['foo']) >= $Λ[$Λ.length - 1].l ? sec_lvl('$tmp4', null, true, $Γ['global']['foo']) : $Λ[$Λ.length - 1].l;
	...
	$Λ.push({
		l: $Λ[$Λ.length - 1].l >= sec_lvl('$tmp3', null, true, $Γ['global']['foo']) ? $Λ[$Λ.length - 1].l : sec_lvl('$tmp3', null, true, $Γ['global']['foo']),
		id: 'IF'
	});
	if ($tmp3) {
		obj.pwdLength = 10;
		$scope($Γ['global']['foo'], 'obj', false)['obj']['pwdLength'] = $Λ[$Λ.length - 1].l;
		$scope($Γ['global']['foo'], 'obj', false)['obj']['pwdLength'] instanceof Object ? $scope($Γ['global']['foo'], 'obj', false)['obj']['pwdLength'].Σ = $scope($Γ['global']['foo'], 'obj', false)['obj']['pwdLength'].Σ >= $Λ[$Λ.length - 1].l ? $scope($Γ['global']['foo'], 'obj', false)['obj']['pwdLength'].Σ : $Λ[$Λ.length - 1].l : $scope($Γ['global']['foo'], 'obj', false)['obj']['pwdLength'] = $scope($Γ['global']['foo'], 'obj', false)['obj']['pwdLength'] >= $Λ[$Λ.length - 1].l ? $scope($Γ['global']['foo'], 'obj', false)['obj']['pwdLength'] : $Λ[$Λ.length - 1].l;
		$scope($Γ['global']['foo'], 'obj', false)['obj']['\u03A3'] = $scope($Γ['global']['foo'], 'obj', false)['obj']['\u03A3'] >= sec_lvl('obj', 'pwdLength', true, $Γ['global']['foo']) ? $scope($Γ['global']['foo'], 'obj', false)['obj']['\u03A3'] : sec_lvl('obj', 'pwdLength', true, $Γ['global']['foo']);
		$old_pc = $pc();
		while ($pc().id !== 'FUNC') {
			$Λ.pop();
		}
...
$tmp2 = obj.pwdLength;
$Γ['global']['$tmp2'] = sec_lvl('obj', 'pwdLength', false, $Γ['global']);
