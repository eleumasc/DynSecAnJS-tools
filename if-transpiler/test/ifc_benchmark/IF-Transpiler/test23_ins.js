...
var pass, $tmp0, $tmp1, $tmp2;
$Γ['global']['$tmp2'] = $Γ['global']['$tmp1'] = $Γ['global']['$tmp0'] = $Γ['global']['pass'] = 0;
pass = 'temp1234';
$Γ['global']['pass'] = 1;
...
$tmp0.i = pass.length;
$Γ['global']['$tmp0']['i'] = sec_lvl('pass', 'length', false, $Γ['global']);
$Γ['global']['$tmp0']['i'] instanceof Object ? $Γ['global']['$tmp0']['i'].Σ = $Γ['global']['$tmp0']['i'].Σ >= $Λ[$Λ.length - 1].l ? $Γ['global']['$tmp0']['i'].Σ : $Λ[$Λ.length - 1].l : $Γ['global']['$tmp0']['i'] = $Γ['global']['$tmp0']['i'] >= $Λ[$Λ.length - 1].l ? $Γ['global']['$tmp0']['i'] : $Λ[$Λ.length - 1].l;
$Γ['global']['$tmp0']['\u03A3'] = $Γ['global']['$tmp0']['\u03A3'] >= sec_lvl('$tmp0', 'i', true, $Γ['global']) ? $Γ['global']['$tmp0']['\u03A3'] : sec_lvl('$tmp0', 'i', true, $Γ['global']);
...
$tmp2 = $tmp['i'];
$Γ['global']['$tmp2'] = sec_lvl('$tmp', 'i', false, $Γ['global']);
